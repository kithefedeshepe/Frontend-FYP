        ...
        if (!userType) {
          ...
          try {
            if (userType === 'doctor') {
              ...
              const docResponse = await Axios.post(`http://43.134.34.32:8000/api/signup/doctor/`, {
                username: username,
                password: password,
                profile:{
                  first_name: fname,
              ...
              console.log(userType);
              const patResponse = await Axios.post(`http://43.134.34.32:8000/api/signup/patient/`, {
                username: username,
                password: password,
                profile:{
                  first_name: fname,
